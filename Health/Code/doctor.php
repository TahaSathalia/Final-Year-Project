...
<center style="padding-top: 100px;"><h1>Welcome Dr <?php echo $_SESSION['dname'];?></h1>
...
$sql = "SELECT pname, test, type, amount, contact, adate FROM patient where docname = '$_SESSION[dname]'";
